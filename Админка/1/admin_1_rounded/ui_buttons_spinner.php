...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Metronic | Spinner Buttons</title>
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- END PAGE BAR -->
                    <!-- BEGIN PAGE TITLE-->
                    <h3 class="page-title"> Spinner Buttons
                        <small>Spinner buttons and progress bar buttons</small>
                    </h3>
                    <!-- END PAGE TITLE-->
                    <!-- END PAGE HEADER-->
                    <div class="portlet light portlet-fit bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <div class="caption-desc font-grey-cascade"> To use the spinner effect, please include these 2 classes: <pre class="mt-code">.mt-ladda-btn</pre> and <pre class="mt-code">.ladda-button</pre> to your button element. Then please include one of the many the spinner stlyes
                                    <pre class="mt-code">data-style="expand-left"</pre> to the button element. Finally, add a <pre class="mt-code">span</pre> tag with the class <pre class="mt-code">.ladda-label</pre> for the button label. For more info
                                    on spinner buttons, please visit:
