        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- END PAGE BAR -->
                    <!-- BEGIN PAGE TITLE-->
                    <h3 class="page-title"> Select2 Dropdowns
                                ...
                                <div class="portlet-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <p class="help-block">
                                                <a href="https://select2.github.io/examples.php#rtl">RTL support</a> via <code>dir="rtl"</code></p>
                                        </div>
                                        <div class="col-md-3">
                            ...
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-body">
                                    <p>The theme applies Bootstrap's styles for
                                        ...
                                        <a href="https://select2.github.io/examples.php#disabled">Disabled mode</a>".</p>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
