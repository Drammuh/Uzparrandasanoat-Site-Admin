...
$currentNews = cms_find_news($cms, $_GET['id'] ?? null);
$pageTitle = $currentNews ? $currentNews['title'] : $settings['site_name'];
?>
<!DOCTYPE html>
...
<body class="no-index">
	...
	<div class="wrapper">
		<div class="container">
			<h2 class="title"><?php echo e($currentNews['title'] ?? cms_t('news_title', $cms)); ?></h2>
			<div class="news">
				<div class="row">
					<div class="col-md-9">
						<div class="page">
							<div class="thumb_box"><img src="<?php echo e($currentNews['large_image'] ?? $currentNews['image'] ?? 'img/bpict.jpg'); ?>" alt=""></div>
							<div class="categ"><?php echo e($currentNews['category'] ?? ''); ?></div>
							<div class="body"><?php cms_paragraphs($currentNews['body'] ?? ''); ?></div>
						</div>
					</div>
