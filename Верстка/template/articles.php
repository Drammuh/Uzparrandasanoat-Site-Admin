...
$pageTitle = cms_t('articles_title', $cms);
$pagination = cms_paginate_items($cms['news'], $_GET['page'] ?? 1, 3);
$featured = $pagination['page'] === 1 ? ($pagination['items'][0] ?? null) : null;
$items = $featured ? array_slice($pagination['items'], 1) : $pagination['items'];
?>
<!DOCTYPE html>
...
<body class="no-index">
	...
	<div class="wrapper">
		<div class="container">
			...
			<div class="news article-archive">
				<div class="row">
					<div class="col-md-9">
						<?php if ($featured): ?>
						<a class="article-featured" href="<?php echo e(cms_news_url($featured)); ?>">
							<span class="article-featured__image"><img src="<?php echo e($featured['large_image'] ?? $featured['image']); ?>" alt=""></span>
							<span class="article-featured__body">
								<span class="article-featured__category"><?php echo e($featured['category']); ?></span>
								<strong><?php echo e($featured['title']); ?></strong>
								<em><?php echo e($featured['excerpt']); ?></em>
							</span>
						</a>
						<?php endif; ?>
						...
						<div class="row">
							...
							<div class="col-md-6">
								<a class="article-card" href="<?php echo e(cms_news_url($item)); ?>">
									<span class="article-card__image"><img src="<?php echo e($item['image']); ?>" alt=""></span>
									<span class="article-card__body">
										<span><?php echo e($item['category']); ?></span>
										<strong><?php echo e($item['title']); ?></strong>
										<em><?php echo e($item['excerpt']); ?></em>
									</span>
								</a>
							</div>
							<?php endforeach; ?>
						</div>
						<?php cms_render_pagination($pagination, 'articles.php'); ?>
					</div>
