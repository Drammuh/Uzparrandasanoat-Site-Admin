...
$pageTitle = cms_t('contact_title', $cms);
?>
<!DOCTYPE html>
...
<body class="no-index">
	...
	<div class="wrapper">
		<div class="container">
			...
			<div class="contact">
				<div class="row">
					<div class="col-md-4"><i class="fa fa-map-marker"></i><p><?php echo e($settings['address']); ?></p></div>
					<div class="col-md-4"><i class="fa fa-phone"></i><p><?php echo e($settings['phone_1']); ?><br><?php echo e($settings['phone_2']); ?></p></div>
					<div class="col-md-4"><i class="fa fa-envelope"></i><p><?php echo e($settings['email']); ?></p></div>
				</div>
			</div>
		</div>
	</div>
